...
echo -n '<link rel="stylesheet" href="e_stylesheets/b_style.css?v=' >> workingVersion.html;
                  echo -n $(date -r ./e_stylesheets/b_style.css +%Y%m%d%H%M%S) >> workingVersion.html;
                                                                 echo '"/>' >> workingVersion.html;
echo -n '<link rel="stylesheet" href="e_stylesheets/c_style.css?v=' >> workingVersion.html;
                  echo -n $(date -r ./e_stylesheets/c_style.css +%Y%m%d%H%M%S) >> workingVersion.html;
                                                                 echo '"/>' >> workingVersion.html;
echo -n '<link rel="stylesheet" href="e_stylesheets/d_style.css?v=' >> workingVersion.html;
                  echo -n $(date -r ./e_stylesheets/d_style.css +%Y%m%d%H%M%S) >> workingVersion.html;
                                                                 echo '"/>' >> workingVersion.html;
echo -n '<link rel="stylesheet" href="e_stylesheets/e_style.css?v=' >> workingVersion.html;
                  echo -n $(date -r ./e_stylesheets/e_style.css +%Y%m%d%H%M%S) >> workingVersion.html;
                                                                 echo '"/>' >> workingVersion.html;
echo >> workingVersion.html;
