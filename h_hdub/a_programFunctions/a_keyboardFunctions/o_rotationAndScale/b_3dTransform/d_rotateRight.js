function rotateRight() {
    if (coinFocus != null) {
        ...
        let newRotateY = rotateY + rotationStep;
        if (newRotateY >= 360) newRotateY -= 360;
        else if (newRotateY < 0) newRotateY += 360;
        coinFocus.lastElementChild.dataset.rotateY = newRotateY;
        const transformStr = "perspective(" + perspective + "px) rotateX(" + rotateX + "deg) rotateY(" + newRotateY + "deg) rotateZ(" + rotateZ + "deg) translateZ(" + translateZ + "px)";
