...
async function popJSON() { popInsert("json",`<div style="width: 100%; height:100%; padding: 0px; margin: 0px; border: 0px; font-size: inherit; background: url('data:image/png;base64,'); background-size: 20px 32px;"><textarea name="jsonBrick" oninput="try { this.parentNode.parentNode.parentNode.parentNode.dataset.json = JSON.stringify(JSON.parse(this.value)); this.parentNode.parentNode.parentNode.parentNode.dataset.shrink = await shrink(JSON.stringify(JSON.parse(this.value))); this.style.backgroundColor = 'rgba(255,255,255,0.8)'; } catch { this.parentNode.parentNode.parentNode.parentNode.dataset.json = this.value; this.style.backgroundColor = 'rgba(255,240,240,0.8)'; };" style="width: 100%; height: 100%; padding: 0px; margin: 0px; border: 0px; resize:none; font-size: inherit; background-color: rgba(255,255,255,0.8);"></textarea></div>`); }
