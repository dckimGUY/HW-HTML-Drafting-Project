...
<input id="buttonLeft"   name="buttonLeft"   title="buttonLeft"   class="input_pos input_buttonLeft"   type="color" value="#737973">
<input id="buttonTop"    name="buttonTop"    title="buttonTop"    class="input_pos input_buttonTop"    type="color" value="#B485CD">
<input id="buttonRight"  name="buttonRight"  title="buttonRight"  class="input_pos input_buttonRight"  type="color" value="#C5C2C5">
<input id="buttonBottom" name="buttonBottom" title="buttonBottom" class="input_pos input_buttonBottom" type="color" value="#A4AAA4">
<input id="textRight"    name="textRight"    title="textRight"    class="input_pos input_textRight"    type="color" value="#FFA3A3">
<input id="textBottom"   name="textBottom"   title="textBottom"   class="input_pos input_textBottom"   type="color" value="#737973">
<input id="textFace"     name="textFace"     title="textFace"     class="input_pos input_textFace"     type="color" value="#00FF00">
<input id="textHover"    name="textHover"    title="textHover"    class="input_pos input_textHover"    type="color" value="#00A1EE">
