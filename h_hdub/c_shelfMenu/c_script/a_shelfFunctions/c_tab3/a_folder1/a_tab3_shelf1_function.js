...
coinFocus.lastElementChild.firstElementChild.innerHTML = buttonHTML1 + buttonLinkValue + buttonHTML2;
coinFocus.lastElementChild.firstElementChild.lastElementChild.style.width  = "100%";
coinFocus.lastElementChild.firstElementChild.lastElementChild.style.height = "100%";
coinFocus.lastElementChild.firstElementChild.lastElementChild.style.left   =  "0px";
coinFocus.lastElementChild.firstElementChild.lastElementChild.style.backgroundSize = "100% 100%";
}
...
coinFocus.lastElementChild.firstElementChild.innerHTML = buttonHTML1 + navLinkEntry + buttonHTML2;
coinFocus.lastElementChild.firstElementChild.lastElementChild.style.width  = "100%";
coinFocus.lastElementChild.firstElementChild.lastElementChild.style.height = "100%";
coinFocus.lastElementChild.firstElementChild.lastElementChild.style.left   =  "0px";
coinFocus.lastElementChild.firstElementChild.lastElementChild.style.backgroundSize = "100% 100%";
