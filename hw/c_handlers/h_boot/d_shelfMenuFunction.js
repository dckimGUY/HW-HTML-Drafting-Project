...
if (lowerShelf.style.display == "none") {
lowerShelf.style.display = "block";
interfaceShelf.firstElementChild.style.height = "1098px";
toolShelf.style.height = "1098px";
localStorage.setItem("lowerShelf", "block");
} else {
lowerShelf.style.display = "none";
interfaceShelf.firstElementChild.style.height = "66px";
toolShelf.style.height = "66px";
localStorage.setItem("lowerShelf", "none" );
}
});

document.getElementById("savePage").addEventListener( "click", function() { saveParticlePreparation(1,false); });
...
if (localStorage.getItem("lowerShelf")) {
       if (localStorage.getItem("lowerShelf")=="none" ) {
lowerShelf.style.display = "none";
interfaceShelf.firstElementChild.style.height = "66px";
toolShelf.style.height = "66px";
} else if (localStorage.getItem("lowerShelf")=="block") {
lowerShelf.style.display = "block";
interfaceShelf.firstElementChild.style.height = "1098px";
toolShelf.style.height = "1098px";
}
...
document.getElementById("partName").addEventListener("input", function() { if (coinFocus!=null) { if (curFocus==0) { coinFocus.id = document.getElementById("partName").value;               } } });
